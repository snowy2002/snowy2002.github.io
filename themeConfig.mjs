...
export const themeConfig = {
  ...
  cover: {
    ...
    showCover: {
      ...
      // 默认封面(随机展示)
      defaultCover: [
        'https://t.alcy.cc/pc?random=1',
        'https://t.alcy.cc/pc?random=2',
        'https://t.alcy.cc/pc?random=3',
        'https://t.alcy.cc/pc?random=4',
        'https://t.alcy.cc/pc?random=5',
        'https://t.alcy.cc/pc?random=6',
        'https://t.alcy.cc/pc?random=7',
        'https://t.alcy.cc/pc?random=8',
        'https://t.alcy.cc/pc?random=9',
        'https://t.alcy.cc/pc?random=10',
        'https://t.alcy.cc/pc?random=11',
        'https://t.alcy.cc/pc?random=12',
        'https://t.alcy.cc/pc?random=13',
        'https://t.alcy.cc/pc?random=14',
        'https://t.alcy.cc/pc?random=15',
        'https://t.alcy.cc/pc?random=16',
        'https://t.alcy.cc/pc?random=17',
        'https://t.alcy.cc/pc?random=18',
        'https://t.alcy.cc/pc?random=19',
        'https://t.alcy.cc/pc?random=20',
        'https://t.alcy.cc/pc?random=21',
        'https://t.alcy.cc/pc?random=22',
        'https://t.alcy.cc/pc?random=23',
        'https://t.alcy.cc/pc?random=24',
        'https://t.alcy.cc/pc?random=25',
        'https://t.alcy.cc/pc?random=26',
        'https://t.alcy.cc/pc?random=27',
        'https://t.alcy.cc/pc?random=28',
        'https://t.alcy.cc/pc?random=29',
        'https://t.alcy.cc/pc?random=30',
        'https://t.alcy.cc/pc?random=31',
        'https://t.alcy.cc/pc?random=32',
        'https://t.alcy.cc/pc?random=33',
        'https://t.alcy.cc/pc?random=34',
        'https://t.alcy.cc/pc?random=35',
        'https://t.alcy.cc/pc?random=36',
        'https://t.alcy.cc/pc?random=37',
        'https://t.alcy.cc/pc?random=38',
        'https://t.alcy.cc/pc?random=39',
